<template>
  ...
  >
    ...
    <div class="flex items-center gap-3 px-6 py-5 border-b border-gray-100">
      ...
      <!-- Close button (mobile) -->
      <button
        class="ml-auto lg:hidden p-1 rounded-md hover:bg-gray-100"
        @click="$emit('close')"
      >
    ...
    <div class="px-4 py-4 border-t border-gray-100">
      ...
      <button
        class="mt-2 w-full flex items-center gap-3 px-3 py-2 rounded-lg text-sm text-gray-600 hover:bg-red-50 hover:text-red-600 transition-colors duration-150"
