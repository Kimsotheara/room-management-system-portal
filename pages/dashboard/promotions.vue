  ...
  <div class="space-y-6">
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      ...
      <button
        ...
        v-if="can(PERM.PROMOTION.CREATE)" @click="openCreate"
      >
              ...
              <td class="px-5 py-4">
                <div class="flex flex-wrap items-center justify-end gap-1.5">
                  ...
                  <button
                    ...
                    v-if="can(PERM.PROMOTION.UPDATE)" @click="openEdit(promo)"
                  >
                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <button
                    ...
                    v-if="can(PERM.PROMOTION.DELETE)" @click="openDelete(promo)"
                  >
                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
definePageMeta({ layout: 'default', middleware: 'auth', permission: 'PROMOTION_READ' })
