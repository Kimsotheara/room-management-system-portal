  ...
  <div class="space-y-6">
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      ...
      <button
        ...
        v-if="can(PERM.ROOM_TYPE.CREATE)" @click="openCreate"
      >
              ...
              <td class="px-5 py-4">
                <div class="flex items-center justify-end gap-1">
                  <button
                    ...
                    v-if="can(PERM.ROOM_TYPE.UPDATE)" @click="openEdit(rt)"
                  >
                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <button
                    ...
                    v-if="can(PERM.ROOM_TYPE.DELETE)" @click="openDelete(rt)"
                  >
                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
definePageMeta({ layout: 'default', middleware: 'auth', permission: 'ROOM_TYPE_READ' })
