  ...
  <div class="space-y-6">
    ...
    <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
      ...
      <button
        ...
        v-if="can(PERM.ROLE.CREATE)" @click="openCreate"
      >
              ...
              <td class="px-5 py-4">
                <div class="flex items-center justify-end gap-1">
                  <button
                    ...
                    title="Edit role"
                    v-if="can(PERM.ROLE.UPDATE)" @click="openEdit(role)"
                  >
                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <button
                    ...
                    title="Delete role"
                    v-if="can(PERM.ROLE.DELETE)" @click="openDelete(role)"
                  >
                    <svg class="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
definePageMeta({ layout: 'default', middleware: 'auth', permission: 'ROLE_READ' })
